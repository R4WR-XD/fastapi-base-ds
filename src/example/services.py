...
def leer_vehiculo(db: Session, vehiculo_id: str) -> Vehiculo:
...
def modificar_vehiculo(db: Session, vehiculo_id: str, vehiculo: schemas.VehiculoUpdate) -> Vehiculo:
    db_vehiculo = leer_vehiculo(db, vehiculo_id)
    return db_vehiculo.update(db, marca=vehiculo.marca, modelo=vehiculo.modelo)


def eliminar_vehiculo(db: Session, vehiculo_id: str) -> Vehiculo:
